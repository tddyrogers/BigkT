...
output=prod[mom1,mom1]*C1[momentumshift];
output+=(prod[mom2,mom2] + 2 prod[mom1,mom2])*C2[momentumshift];
...
code1[i_]:="[momentumshift_]:=Module[\[IndentingNewLine]{\[IndentingNewLine]Graham=getGrahamMatrixTriangle[momentumshift],\[IndentingNewLine]Rarray={Rc1[momentumshift],Rc2[momentumshift]},\[IndentingNewLine]invertible=0,\[IndentingNewLine]sol={}\[IndentingNewLine]},\[IndentingNewLine]\[IndentingNewLine]invertible=If[Det[Graham]\[Equal]0,0,1,1];\[IndentingNewLine]\[IndentingNewLine]If[invertible\[Equal]1,\[IndentingNewLine]\[IndentingNewLine]sol=Inverse[Graham].(Rarray);\[IndentingNewLine]\[IndentingNewLine]sol[["<>ToString[i]<>"]],\[IndentingNewLine]\[IndentingNewLine]C"<>ToString[i]<>"[momentumshift],(*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]C"<>ToString[i]<>"[momentumshift] (*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]]\[IndentingNewLine]\[IndentingNewLine]\[IndentingNewLine]]"
...
code1[2]
\!\(TraditionalForm\`"\<[momentumshift_]:=Module[\[IndentingNewLine]{\[IndentingNewLine]Graham=getGrahamMatrixTriangle[momentumshift],\[IndentingNewLine]Rarray={Rc1[momentumshift],Rc2[momentumshift]},\[IndentingNewLine]invertible=0,\[IndentingNewLine]sol={}\[IndentingNewLine]},\[IndentingNewLine]\[IndentingNewLine]invertible=If[Det[Graham]\[Equal]0,0,1,1];\[IndentingNewLine]\[IndentingNewLine]If[invertible\[Equal]1,\[IndentingNewLine]\[IndentingNewLine]sol=Inverse[Graham].(Rarray);\[IndentingNewLine]\[IndentingNewLine]sol[[2]],\[IndentingNewLine]\[IndentingNewLine]C2[momentumshift],(*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]C2[momentumshift] (*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]]\[IndentingNewLine]\[IndentingNewLine]\[IndentingNewLine]]\>"\)
...
-prod[mom1,mom1]/2 C1[momentumshift]
]
...
-1/2 B1v[{momentumshift[[1]],momentumshift[[3]]}]
-(prod[mom2,mom2]+2 prod[mom1,mom2])/2*C1[momentumshift]
]
...
-prod[mom1,mom1]/2*C2[momentumshift](*BW:should be C2*)
]
...
-(prod[mom2,mom2]+2 prod[mom1,mom2])/2 C2[momentumshift](*BW:should be C2*)
]
...
output+= prod[mom1,mom1]*D1[momentumshift];
output+= (prod[mom2,mom2]+2*prod[mom1,mom2])*D2[momentumshift];
output+= (prod[mom3,mom3]+2*prod[mom3,mom1]+2*prod[mom3,mom2])*D3[momentumshift];
...
code3[i_]:="[momentumshift_]:=Module[\[IndentingNewLine]{\[IndentingNewLine]Graham=getGrahamMatrixBox[momentumshift],\[IndentingNewLine]Rarray={Rd1[momentumshift],Rd2[momentumshift],Rd3[momentumshift]},\[IndentingNewLine]invertible=0,\[IndentingNewLine]sol={}\[IndentingNewLine]},\[IndentingNewLine]\[IndentingNewLine]invertible=If[Det[Graham]\[Equal]0,0,1,1];\[IndentingNewLine]\[IndentingNewLine]If[invertible\[Equal]1,\[IndentingNewLine]\[IndentingNewLine]sol=Inverse[Graham].(Rarray);\[IndentingNewLine]\[IndentingNewLine]sol[["<>ToString[i]<>"]],\[IndentingNewLine]\[IndentingNewLine]D"<>ToString[i]<>"[momentumshift],(*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]D"<>ToString[i]<>"[momentumshift] (*if Graham matrix is singular, leave unevaluated, for now*)\[IndentingNewLine]\[IndentingNewLine]]\[IndentingNewLine]\[IndentingNewLine]\[IndentingNewLine]]"
...
1/2 C0v[{momentumshift[[2]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C1[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
-prod[mom1,mom1]/2 D1[momentumshift]
-D00[momentumshift]
...
-(1/2)C1[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C1[{momentumshift[[1]],momentumshift[[2]],momentumshift[[4]]}]
-(prod[mom2,mom2]+2 prod[mom1,mom2])/2 D1[momentumshift]
...
+(1/2)C1[{momentumshift[[1]],momentumshift[[2]],momentumshift[[3]]}]
-1/2 C1[{momentumshift[[1]],momentumshift[[2]],momentumshift[[4]]}]
-(prod[mom3,mom3]+2 prod[mom1,mom3]+2 prod[mom2,mom3])/2 D1[momentumshift]
...
-(1/2)C1[{momentumshift[[2]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C1[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
-prod[mom1,mom1]/2 D2[momentumshift]
...
-(1/2)C1[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C2[{momentumshift[[1]],momentumshift[[2]],momentumshift[[4]]}]
-(prod[mom2,mom2]+2 prod[mom2,mom1])/2 D2[momentumshift]
-D00[momentumshift]
...
+(1/2)C2[{momentumshift[[1]],momentumshift[[2]],momentumshift[[3]]}]
-1/2 C2[{momentumshift[[1]],momentumshift[[2]],momentumshift[[4]]}]
-(prod[mom3,mom3]+2 prod[mom1,mom3]+2 prod[mom2,mom3])/2 D2[momentumshift]
]
...
-(1/2)C2[{momentumshift[[2]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C2[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
-prod[mom1,mom1]/2 D3[momentumshift]
...
-(1/2)C2[{momentumshift[[1]],momentumshift[[3]],momentumshift[[4]]}]
+1/2 C2[{momentumshift[[1]],momentumshift[[2]],momentumshift[[4]]}]
-(prod[mom2,mom2]+2 prod[mom2,mom1])/2 D3[momentumshift]
]
...
-(prod[mom3,mom3]+2 prod[mom1,mom3]+2 prod[mom2,mom3])/2 D3[momentumshift]
...
boxstep5=Table["D"<>ToString[i]<>"->"<>"D"<>ToString[i]<>"eval",{i,1,3}];
...
trianglestep3=Table["C"<>ToString[i]<>"->"<>"C"<>ToString[i]<>"eval",{i,1,2}];
...
bubblestep1=Table["B"<>ToString[i]<>"->"<>"B"<>ToString[i]<>"eval",{i,1,1}]
...
{psfac,avefac,term1,term2,total,imaginary,real,final,SQAMPs,
...
psfac=avefac*4*Pi*\[Mu]^(2\[Epsilon])/(2Pi)^4;
term1=
