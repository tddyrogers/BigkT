...
DropSumOver->True,ChangeDimension->D,UndoChiralSplittings->True,List->False,SMP->True];
...
DropSumOver->True,ChangeDimension->D,UndoChiralSplittings->True,List->False,SMP->True]*fac//.subcnt;
(*Print[Style[amp2,FontColor\[Rule]Red]];*)
ClearScalarProducts;
(*Print[amp];*)
SetMandelstam[s,t,u,p1,p2,-q1,-q2,-Q^2,0,0,0];
