...
sqampAgtoqqb[s_,t_]:=((8*g^2*s)/3)*3/8*1/(1-\[Epsilon]);(*note 3/8 accounts for the wrong average for gluon, 1/(1-\[Epsilon]) for wrong gluon spin avergage*)
sqampAgtoqbq[s_,t_]:=((8*g^2*s)/3)*3/8*1/(1-\[Epsilon]);
sqampAqtoqg[s_,t_]:=(-4*g^2*(Q^2 + s + t)*(-1 + \[Epsilon]))/3;
sqampAqbtoqbg[s_,t_]:=(-4*g^2*(Q^2 + s + t)*(-1 + \[Epsilon]))/3;

sqampAqtogq[s_,t_]:=(4*g^2*t*(-1 + \[Epsilon]))/3;
...
counterxsec1=Series[-1/t*(s23-t)^2/t^2*bornxsecAgtoqqb[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2gtogs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.Subscript[C, A]->3//Simplify//Normal;
counterxsec2=Series[-1/t*(s23-t)^2/t^2*bornxsecAqtoqg[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2gtoqs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.w->1-y//Simplify//Normal;
...
counterxsec1=Series[-1/t*(s23-t)^2/t^2*bornxsecAqtogq[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2gtoqs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.w->1-y//Simplify//Normal;
...
counterxsec=2*counterxsec1+2*counterxsec2//Normal//Collect[#,\[Epsilon]]&(*factor 2 since splitting can be both q and qb*)
];(*pole term checked*)
...
bornxsecAqtoqg[s_,t_]:=prefac[s,t]*sqampAqtoqg[s,t];
counterxsec1=Series[-1/t*(s23-t)^2/t^2*bornxsecAqtoqg[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2qtoqs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.Subscript[C, F]->4/3/.w->1-y//Simplify//Normal;
...
bornxsecAqtoqg[s_,t_]:=prefac[s,t]*sqampAqtoqg[s,t];
bornxsecAqtogq[s_,t_]:=prefac[s,t]*sqampAqtogq[s,t];
counterxsec1=Series[-1/t*(s23-t)^2/t^2*bornxsecAqtogq[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2qtoqs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[C, A]->3/.Subscript[T, R]->1/2/.Subscript[C, F]->4/3/.w->1-y//Simplify//Normal;
...
bornxsecAgtoqqb[s_,t_]:=prefac[s,t]*sqampAgtoqqb[s,t];
bornxsecAqtogq[s_,t_]:=prefac[s,t]*sqampAqtogq[s,t];
counterxsec1=Series[-1/t*(s23-t)^2/t^2*bornxsecAgtoqqb[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2qtogs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.Subscript[C, F]->4/3/.w->1-y//Simplify//Normal;
...
bornxsecAgtoqqb[s_,t_]:=prefac[s,t]*sqampAgtoqqb[s,t];
bornxsecAqtogq[s_,t_]:=prefac[s,t]*sqampAqtogq[s,t];
counterxsec1=Series[-1/t*(s23-t)^2/t^2*(gp/g)^2*bornxsecAgtoqqb[-((s*t+Q^2*s23)/(s23-t)),t]*Rp2qtogs2[s23,M]*1/(8Pi^2),{\[Epsilon],0,0}]/.Subscript[T, R]->1/2/.Subscript[C, F]->4/3/.w->1-y//Simplify//Normal;
