...
i==2&&j==-3,1/(2 (-1+D^2)) \[Pi] (2 (8-6 D^2+c^3 D (13-15 D^2)+3 c D (-5+3 D^2)+6 c^2 (-2+3 D^2))+3 (-1+D^2) (2 D+c (3-6 c D-3 D^2+c^2 (-1+5 D^2))) Log[(1+D)/(-1+D)])/.\[Epsilon]->-2\[Epsilon],
i==1&&j==-3,1/6 \[Pi] (18 D+2 c (24-4 c^2-27 c D+3 (-3+5 c^2) D^2)+3 (-1+c D) (5-4 c D-3 D^2+c^2 (-3+5 D^2)) Log[(-1+D)/(1+D)])+1/36 \[Pi] \[Epsilon] (8 c (-39+8 c^2)+54 (-3+7 c^2) D+18 c (9-13 c^2) D^2+27 (-1+c^2) (-1+c D) (-1+D^2) Log[(1+D)/(-1+D)]+9 (-1+c D) (5-4 c D-3 D^2+c^2 (-3+5 D^2)) (1/2 Log[(-1+D)/(1+D)]^2+2 PolyLog[2,2/(1+D)]))/.\[Epsilon]->-2\[Epsilon],
i==2&&j==-4,1/(6 (-1+D^2)) \[Pi] (32 (3-6 c^2+c^4)+24 c (-11+13 c^2) D-2 (51-222 c^2+115 c^4) D^2+72 c (3-5 c^2) D^3+6 (3-30 c^2+35 c^4) D^4+3 (-1+D^2) (c^3 (12-60 D^2)+6 c^2 D (9-5 D^2)+3 D (-5+D^2)+5 c^4 D (-3+7 D^2)+4 c (-5+9 D^2)) Log[(-1+D)/(1+D)])/.\[Epsilon]->-2\[Epsilon],
i==1&&j==-4,1/24 \[Pi] (-128 c (-3+c^2)+2 (87-294 c^2+55 c^4) D+96 c (-3+5 c^2) D^2-6 (3-30 c^2+35 c^4) D^3-3 (35-30 D^2+3 D^4+16 c^3 D (3-5 D^2)+16 c D (-5+3 D^2)-6 c^2 (5-18 D^2+5 D^4)+c^4 (3-30 D^2+35 D^4)) Log[(-1+D)/(1+D)])/.\[Epsilon]->-2\[Epsilon],
